...
- **`test_regression_guards.py`** — generic guards for the *classes* of bug that keep recurring in playtest, each encoding one hard-won lesson (see `docs/tts-runtime.md`). Eight checks:
