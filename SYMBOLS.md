...
| 361 | function | `identifyThreatType` |
| 376 | function | `resolveStorytelling` |
| 403 | function | `resolveSleep` |
...
| `identifyThreatType` | lua/night.lua | 361 |
...
| `resolveSleep` | lua/night.lua | 403 |
