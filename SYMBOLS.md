...
| 204 | function | `onPressAttack` |
| 225 | function | `onFinishCombat` |
| 236 | function | `onActTrade` |
| 274 | function | `onTradeTargetClick` |
| 284 | function | `onTradeCancel` |
| 294 | function | `onActPeek` |
| 305 | function | `onPeekDeckClick` |
| 311 | function | `onPeekCancel` |
| 321 | function | `onActRally` |
| 346 | function | `onRallyTargetClick` |
| 356 | function | `onRallyCancel` |
| 366 | function | `onActUndo` |
| 379 | function | `onDuskReadyClick` |
| 384 | function | `onDuskMoveClick` |
...
| 173 | function | `onHostBeginDay` |
| 190 | function | `onHostResolveNight` |
| 203 | function | `onHostEndTurn` |
| 213 | function | `onHostRestart` |
| 255 | function | `showEndOfDaySummary` |
| 322 | function | `onSummaryClose` |
| 333 | function | `ensureChronicle` |
| 350 | function | `recordKillInChronicle` |
| 366 | function | `recordMealInChronicle` |
| 371 | function | `recordCharlieInChronicle` |
| 381 | function | `recordDayInChronicle` |
| 419 | function | `showWeekInReview` |
| 486 | function | `onWeekReviewClose` |
| 494 | table | `TOOLTIP_DATA` |
| 523 | function | `applyTooltips` |
| 542 | function | `refreshDynamicTooltips` |
...
| `TOOLTIP_DATA` | lua/ui_controls.lua | 494 |
...
| `applyTooltips` | lua/ui_controls.lua | 523 |
...
| `ensureChronicle` | lua/ui_controls.lua | 333 |
...
| `onActPeek` | lua/ui_actionbar_handlers.lua | 294 |
| `onActPry` | lua/ui_actionbar_handlers.lua | 153 |
| `onActRally` | lua/ui_actionbar_handlers.lua | 321 |
| `onActRest` | lua/ui_actionbar_handlers.lua | 123 |
| `onActSignature` | lua/signatures.lua | 288 |
| `onActTrade` | lua/ui_actionbar_handlers.lua | 236 |
| `onActUndo` | lua/ui_actionbar_handlers.lua | 366 |
...
| `onDuskMoveClick` | lua/ui_actionbar_handlers.lua | 384 |
| `onDuskReadyClick` | lua/ui_actionbar_handlers.lua | 379 |
| `onFightTargetClick` | lua/ui_actionbar_targets.lua | 290 |
| `onFightTogetherClick` | lua/ui_actionbar_targets.lua | 294 |
| `onFinishCombat` | lua/ui_actionbar_handlers.lua | 225 |
| `onHelpClick` | lua/ui_help.lua | 111 |
| `onHelpClose` | lua/ui_help.lua | 121 |
| `onHelpTab` | lua/ui_help.lua | 125 |
| `onHostBeginDay` | lua/ui_controls.lua | 173 |
| `onHostEndTurn` | lua/ui_controls.lua | 203 |
| `onHostResolveNight` | lua/ui_controls.lua | 190 |
| `onHostRestart` | lua/ui_controls.lua | 213 |
| `onHostSetupGuided` | lua/ui_setup.lua | 591 |
| `onLoad` | lua/global.lua | 244 |
| `onMoveTargetClick` | lua/ui_actionbar_targets.lua | 204 |
| `onPeekCancel` | lua/ui_actionbar_handlers.lua | 311 |
| `onPeekDeckClick` | lua/ui_actionbar_handlers.lua | 305 |
| `onPickChar` | lua/ui_setup.lua | 322 |
| `onPickPath` | lua/ui_setup.lua | 90 |
| `onPosterizeTargetClick` | lua/signatures.lua | 220 |
| `onPressAttack` | lua/ui_actionbar_handlers.lua | 204 |
| `onRallyCancel` | lua/ui_actionbar_handlers.lua | 356 |
| `onRallyTargetClick` | lua/ui_actionbar_handlers.lua | 346 |
...
| `onSummaryClose` | lua/ui_controls.lua | 322 |
...
| `onTradeCancel` | lua/ui_actionbar_handlers.lua | 284 |
| `onTradeTargetClick` | lua/ui_actionbar_handlers.lua | 274 |
| `onVariantsContinue` | lua/ui_setup.lua | 157 |
| `onWeekReviewClose` | lua/ui_controls.lua | 486 |
...
| `recordCharlieInChronicle` | lua/ui_controls.lua | 371 |
| `recordDayInChronicle` | lua/ui_controls.lua | 381 |
| `recordKillInChronicle` | lua/ui_controls.lua | 350 |
| `recordMealInChronicle` | lua/ui_controls.lua | 366 |
...
| `refreshDynamicTooltips` | lua/ui_controls.lua | 542 |
