...
Walks `sounds/` and emits a Lua table grouping URLs + durations by category:
  - AUDIO.AMBIENT_SUBURBAN  — sounds/ambient/suburban/*  (the day tracks)
  - AUDIO.AMBIENT_NIGHT     — sounds/ambient/night/*  (low drones for the Night phase)
  - AUDIO.CREATURES.<name>  — sounds/creatures/<name>/*  (deerclops/eye_of_terror/treeguard)
...
def main():
    ...
    L.append("-- Sources: sounds/ambient/{suburban,night}, sounds/creatures/*, sounds/sfx")
